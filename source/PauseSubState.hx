			...
			switch (daSelected)
			{
				...
				case "Exit to menu":
					...
					if (PlayState.isStoryMode)
					{
						...
						StoryMenuState.songOrigin = PlayState.curSong.toLowerCase();
						StoryMenuState.diffOrigin = CoolUtil.difficultyFromInt(PlayState.storyDifficulty);
						StoryMenuState.didLose = true;
