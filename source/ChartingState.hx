	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		if (playClaps)
		{
			...
			{
				if (note.strumTime <= Conductor.songPosition && note.strumTime > Conductor.songPosition - 250
					&& !claps.contains(note) && FlxG.sound.music.playing)
				{
					claps.push(note);
	...
	{
		var difficultyArray:Array<String> = ["-easy", "", "-hard", "-false", "-true"];
